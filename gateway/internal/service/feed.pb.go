...
func (x *TiktokFeedRequest) Reset() {
	*x = TiktokFeedRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protoFile_feed_proto_msgTypes[0]
...
func (*TiktokFeedRequest) Descriptor() ([]byte, []int) {
	return file_protoFile_feed_proto_rawDescGZIP(), []int{0}
}
...
func (x *TiktokFeedResponse) Reset() {
	*x = TiktokFeedResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protoFile_feed_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TiktokFeedResponse) Descriptor() ([]byte, []int) {
	return file_protoFile_feed_proto_rawDescGZIP(), []int{1}
}
...
func (x *TiktokFeedResponse) GetVideoList() []*FeedVideo {
	if x != nil {
		return x.VideoList
	}
	return nil
...
func (x *FeedVideo) Reset() {
	*x = FeedVideo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protoFile_feed_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FeedVideo) Descriptor() ([]byte, []int) {
	return file_protoFile_feed_proto_rawDescGZIP(), []int{2}
}
...
func (x *FeedUser) Reset() {
	*x = FeedUser{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protoFile_feed_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FeedUser) Descriptor() ([]byte, []int) {
	return file_protoFile_feed_proto_rawDescGZIP(), []int{3}
}
...
var File_protoFile_feed_proto protoreflect.FileDescriptor

var file_protoFile_feed_proto_rawDesc = []byte{
	0x0a, 0x14, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x46, 0x69, 0x6c, 0x65, 0x2f, 0x66, 0x65, 0x65, 0x64,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22,
	0x4c, 0x0a, 0x13, 0x74, 0x69, 0x6b, 0x74, 0x6f, 0x6b, 0x5f, 0x66, 0x65, 0x65, 0x64, 0x5f, 0x72,
	...
	0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x2e, 0x46, 0x65, 0x65, 0x64, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x52, 0x09,
	...
	0x78, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x81, 0x02, 0x0a, 0x09, 0x46, 0x65, 0x65, 0x64, 0x56,
	...
	0x65, 0x65, 0x64, 0x55, 0x73, 0x65, 0x72, 0x52, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x12,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x22, 0xe5, 0x02, 0x0a, 0x08, 0x46,
	...
	0x6e, 0x74, 0x32, 0x50, 0x0a, 0x04, 0x46, 0x65, 0x65, 0x64, 0x12, 0x48, 0x0a, 0x09, 0x46, 0x65,
	0x65, 0x64, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x12, 0x1c, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x2e, 0x74, 0x69, 0x6b, 0x74, 0x6f, 0x6b, 0x5f, 0x66, 0x65, 0x65, 0x64, 0x5f, 0x72, 0x65,
...
var (
	file_protoFile_feed_proto_rawDescOnce sync.Once
	file_protoFile_feed_proto_rawDescData = file_protoFile_feed_proto_rawDesc
)

func file_protoFile_feed_proto_rawDescGZIP() []byte {
	file_protoFile_feed_proto_rawDescOnce.Do(func() {
		file_protoFile_feed_proto_rawDescData = protoimpl.X.CompressGZIP(file_protoFile_feed_proto_rawDescData)
	})
	return file_protoFile_feed_proto_rawDescData
}

var file_protoFile_feed_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_protoFile_feed_proto_goTypes = []interface{}{
	(*TiktokFeedRequest)(nil),  // 0: service.tiktok_feed_request
	(*TiktokFeedResponse)(nil), // 1: service.tiktok_feed_response
	(*FeedVideo)(nil),          // 2: service.FeedVideo
	(*FeedUser)(nil),           // 3: service.FeedUser
}
var file_protoFile_feed_proto_depIdxs = []int32{
	2, // 0: service.tiktok_feed_response.video_list:type_name -> service.FeedVideo
	3, // 1: service.FeedVideo.author:type_name -> service.FeedUser
...
func init() { file_protoFile_feed_proto_init() }
func file_protoFile_feed_proto_init() {
	if File_protoFile_feed_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_protoFile_feed_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protoFile_feed_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protoFile_feed_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protoFile_feed_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_protoFile_feed_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_protoFile_feed_proto_goTypes,
		DependencyIndexes: file_protoFile_feed_proto_depIdxs,
		MessageInfos:      file_protoFile_feed_proto_msgTypes,
	}.Build()
	File_protoFile_feed_proto = out.File
	file_protoFile_feed_proto_rawDesc = nil
	file_protoFile_feed_proto_goTypes = nil
	file_protoFile_feed_proto_depIdxs = nil
}
